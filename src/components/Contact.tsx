      ...
      <div className="container-px">
        <Reveal>
          <SectionTitle
            ...
            description="Entre em contato pelo WhatsApp ou Instagram para agendar seu atendimento. Horários personalizados conforme sua disponibilidade."
            align="center"
          />
        </Reveal>

        <Reveal delay={120} className="mx-auto mt-12 grid max-w-2xl gap-4 sm:grid-cols-2">
          <ContactLink
